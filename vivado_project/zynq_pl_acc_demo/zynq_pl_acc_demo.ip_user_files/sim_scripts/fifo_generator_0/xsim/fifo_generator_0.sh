...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_4 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_generator_0 xil_defaultlib.fifo_generator_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_generator_0 -key {Behavioral:sim_1:Functional:fifo_generator_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_44e3.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
