...
#
# Generated by Vivado on Tue Mar 21 10:08:22 +0800 2023
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"E:/Vivado/Vivado/2019.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"E:/Vivado/Vivado/2019.1/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_4 $vlogan_opts +v2k +incdir+"E:/Vivado/Vivado/2019.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"E:/Vivado/Vivado/2019.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../zynq_pl_acc_demo.srcs/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.v" \
  2>&1 | tee -a vlogan.log
